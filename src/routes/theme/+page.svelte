...
<section id="typography">
	...
	<figure>
		<img
			src="https://images.unsplash.com/photo-1473984951266-787b955c9e0b"
			alt="Minimal landscape"
		/>
		<figcaption>
			Image from <a href="https://unsplash.com/photos/a562ZEFKW8I" target="_blank">unsplash.com</a>
		</figcaption>
	</figure>
</section>
<!-- ./ Typography-->
...
<section id="accordions">
	...
	<details>
		...
		<p>
			Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque urna diam, tincidunt nec
			porta sed, auctor id velit. Etiam venenatis nisl ut orci consequat, vitae tempus quam commodo.
			Nulla non mauris ipsum. Aliquam eu posuere orci. Nulla convallis lectus rutrum quam hendrerit,
			in facilisis elit sollicitudin. Mauris pulvinar pulvinar mi, dictum tristique elit auctor
...
<aside>
	<a href="/#" aria-label="Example" onclick="event.preventDefault()"
		><img
			src="https://images.unsplash.com/photo-1666023903340-0eb57af0c1a4?ixlib=rb-4.0.3&dl=razvan-dumitrasconiu-h8zhcGLHmuY-unsplash.jpg&w=640&q=80&fm=jpg&crop=entropy&cs=tinysrgb"
			alt="Architecture"
		/></a
	>
	<p>
	...
	<p>
		...
		<small
			>Maecenas vitae nibh blandit dolor commodo egestas vel eget neque. Praesent semper justo orci,
			vel imperdiet mi auctor in.</small
		>
	</p>
</aside>
